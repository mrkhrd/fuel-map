...
- Попап: секция Т-Банк (наличие по видам топлива, оплата, уверенность) и секция Сбер
  (статус станции, наличие по видам топлива с лимитами литров, число оплат, оплата)
- Бейдж у маркера: время последней оплаты Т-Банк (зелёный < 3 ч, серый > 24 ч),
  второй строкой — оплата по Сберу, третьей — цветные чипы наличия по видам топлива
  (станции Сбера сопоставляются по координатам, до 150 м)
